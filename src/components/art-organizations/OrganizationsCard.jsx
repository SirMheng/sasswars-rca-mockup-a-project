...
import ArtOrganizationsData from "../../data/artOrganizationsData.json";

const OrganizationsCard = () => {
  const [events, setEvents] = useState(
    ArtOrganizationsData.map((event) => ({
      ...event,
      isLiked: false,
      image: null,
    }))
    ...
    <div className="absolute top-[165px] px-[120px] w-full z-20">
      <div className="w-full h-[497px] mx-auto flex justify-between items-center">
        {events.map((event, index) => (
          <div key={index}>
            <div className="h-[450px] w-[282px] bg-[#111112] rounded-t-[10px] rounded-b-[10px]">
