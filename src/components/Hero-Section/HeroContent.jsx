  ...
  return (
    <div className="absolute z-1 w-full px-[120px]">
      <div className="max-w-[1200px] mx-auto">
        ...
        <section className="absolute top-[749px] w-[1200px] h-[417px] bg-black/64 backdrop-blur-md flex justify-between items-start  border-2 border-[#1E1F22] rounded-3xl">
